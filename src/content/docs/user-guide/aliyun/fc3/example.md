...
2. 更多 Hello World 示例请参考: [https://github.com/devsapp/start-fc](https://github.com/devsapp/start-fc)
...
resources:
  fcDemo: # 业务名称/模块名称
    ...
    props: # 组件的属性值
      ...
      instanceConcurrency: 1 # # 该参数仅针对 custom/custom.debian10/custom-container runtime 有效，范围为 [1, 200]
