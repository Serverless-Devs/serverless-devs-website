export default {
	...
	'home.website.edge.1.description': 'One-stop solution for dynamic service discovery, configuration management and dynamic DNS service<br>20+ out-of-the-box features for service-centric architectures<br>Light-weight production-ready console',
	'home.website.edge.2.title': 'More adaptive to cloud architectures',
	'home.website.edge.2.description': 'Seamlessly support kubernetes and spring cloud<br>Easier to deploy and run on popular public cloud (for example AliCloud and AWS)<br>Support multi-tenants and multi-environments',
	'home.website.edge.3.title': 'Production grade',
	'home.website.edge.3.description': 'Originated from time-tested internal products from Alibaba Group<br>Supports large-scale scenarios with millions of services<br>Open-source product with enterprise-level SLA',
	'home.website.edge.4.title': 'Rich internet application scenarios affinity',
	'home.website.edge.4.description': 'Supports rate throttling, big promotion plans, and multi-region active-active architectures<br>Supports a variety of relevant internet-based use cases directly or with slight extension<br>Traffic scheduling & service governance',
